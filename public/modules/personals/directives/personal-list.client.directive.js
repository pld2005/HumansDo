...
angular.module('personals').directive('confirmClick', ['$q', 'dialogModal', function($q, dialogModal) {
      return {
          link: function (scope, element, attrs) {
              ...
              scope.confirmClick = function(msg) {
                  ...
                  msg = msg || attrs.confirmClick || 'Está seguro?';
                  //title = title || attrs.confirmClick || 'Oooo';
